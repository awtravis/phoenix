...
/****************************************************************/
#ifndef WidmanstattenMaterial_H
#define WidmanstattenMaterial_H

#include "Material.h"

//Forward Declarations
class WidmanstattenMaterial;
 ...
 */
class WidmanstattenMaterial : public Material
{
public:
  WidmanstattenMaterial(const InputParameters & parameters);
